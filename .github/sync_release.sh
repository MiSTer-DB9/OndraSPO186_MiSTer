...
UPSTREAM_REPO="https://github.com/MiSTer-devel/OndraSPO186_MiSTer.git"
CORE_NAME=(Ondra_SPO186)
...
UPSTREAM_CORE_NAME=(Ondra_SPO186)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Ondra_SPO186.qpf)
COMPILATION_OUTPUT=(output_files/Ondra_SPO186.rbf)
